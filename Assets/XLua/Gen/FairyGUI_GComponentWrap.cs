...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGComponentWrap 
    {
        public static void __Register(RealStatePtr L)
        {
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "tabStopChildren", _g_get_tabStopChildren);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "tabStopChildren", _s_set_tabStopChildren);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new FairyGUI.GComponent();
		    ...
		    try {
                ...
                if(gen_param_count == 3&& translator.Assignable<FairyGUI.GObject>(L, 2)&& LuaTypes.LUA_TBOOLEAN == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    bool _dispose = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.RemoveChild( _child, _dispose );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetChild( _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _path = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetChildByPath( _path );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    string _name = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetVisibleChild( _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    string _name = LuaAPI.lua_tostring(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.GetChildInGroup( _group, _name );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.GObject _obj = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
                        ...
                        var gen_ret = gen_to_be_invoked.IsAncestorOf( _obj );
        ...
        static int _m_ChangeChildrenOrder(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Collections.Generic.IList<FairyGUI.GObject> _objs = (System.Collections.Generic.IList<FairyGUI.GObject>)translator.GetObject(L, 2, typeof(System.Collections.Generic.IList<FairyGUI.GObject>));
                    
                    gen_to_be_invoked.ChangeChildrenOrder( _objs );
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetControllerAt( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetTransitionAt( _index );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    FairyGUI.GObject _child = (FairyGUI.GObject)translator.GetObject(L, 2, typeof(FairyGUI.GObject));
                        ...
                        var gen_ret = gen_to_be_invoked.IsChildInView( _child );
                        LuaAPI.lua_pushboolean(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_tabStopChildren(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GComponent gen_to_be_invoked = (FairyGUI.GComponent)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, gen_to_be_invoked.tabStopChildren);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_tabStopChildren(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GComponent gen_to_be_invoked = (FairyGUI.GComponent)translator.FastGetCSObj(L, 1);
                gen_to_be_invoked.tabStopChildren = LuaAPI.lua_toboolean(L, 2);
