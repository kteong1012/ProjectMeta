...
namespace XLua.CSObjectWrap
{
    ...
    public class FairyGUIGListWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(type, L, translator, 0, 29, 23, 18);
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "EnableSelectionFocusEvents", _m_EnableSelectionFocusEvents);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "EnableArrowKeyNavigation", _m_EnableArrowKeyNavigation);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "defaultItemSize", _g_get_defaultItemSize);
            ...
            Utils.RegisterFunc(L, Utils.SETTER_IDX, "defaultItemSize", _s_set_defaultItemSize);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					var gen_ret = new FairyGUI.GList();
		    ...
		    try {
                ...
                
                {
                    string _url = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.GetFromPool( _url );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                if(gen_param_count == 2&& (LuaAPI.lua_isnil(L, 2) || LuaAPI.lua_type(L, 2) == LuaTypes.LUA_TSTRING)) 
                {
                    string _url = LuaAPI.lua_tostring(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.AddItemFromPool( _url );
                        translator.Push(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    ...
                    bool _dispose = LuaAPI.lua_toboolean(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.RemoveChildAt( _index, _dispose );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_EnableSelectionFocusEvents(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.EnableSelectionFocusEvents( _enabled );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_EnableArrowKeyNavigation(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    gen_to_be_invoked.EnableArrowKeyNavigation( _enabled );
		    ...
		    try {
                ...
                
                {
                    int _dir = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.HandleArrowKey( _dir );
        ...
        static int _m_GetFirstChildInView(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        var gen_ret = gen_to_be_invoked.GetFirstChildInView(  );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.ChildIndexToItemIndex( _index );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
		    ...
		    try {
                ...
                
                {
                    int _index = LuaAPI.xlua_tointeger(L, 2);
                        ...
                        var gen_ret = gen_to_be_invoked.ItemIndexToChildIndex( _index );
                        LuaAPI.xlua_pushinteger(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_defaultItemSize(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                FairyGUI.GList gen_to_be_invoked = (FairyGUI.GList)translator.FastGetCSObj(L, 1);
                translator.PushUnityEngineVector2(L, gen_to_be_invoked.defaultItemSize);
            } catch(System.Exception gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + gen_e);
            }
            return 1;
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _s_set_defaultItemSize(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
				...
				gen_to_be_invoked.defaultItemSize = gen_value;
