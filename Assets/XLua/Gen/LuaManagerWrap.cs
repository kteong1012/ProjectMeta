...
namespace XLua.CSObjectWrap
{
    ...
    public class LuaManagerWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "CallStaticFunc", _m_CallStaticFunc);
			Utils.RegisterFunc(L, Utils.METHOD_IDX, "CallGlobalFunc", _m_CallGlobalFunc);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CallStaticFunc(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    object[] _args = translator.GetParams<object>(L, 4);
                        ...
                        var gen_ret = gen_to_be_invoked.CallStaticFunc( _tableName, _funcName, _args );
                        translator.Push(L, gen_ret);
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _m_CallGlobalFunc(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    object[] _args = translator.GetParams<object>(L, 3);
                        ...
                        var gen_ret = gen_to_be_invoked.CallGlobalFunc( _funcName, _args );
                        translator.Push(L, gen_ret);
